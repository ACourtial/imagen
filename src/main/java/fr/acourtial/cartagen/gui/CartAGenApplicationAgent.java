 ...
 * @copyright IGN
 ******************************************************************************/
package fr.acourtial.cartagen.gui;
...
import fr.ign.cogit.cartagen.appli.core.GeneralisationMenuAgentComplement;
import fr.ign.cogit.cartagen.appli.core.GeneralisationRightPanelAgentComplement;
import fr.ign.cogit.cartagen.appli.core.ThemesAgentComplementGUIComponent;
...
import fr.acourtial.cartagen.plugins.PluginAzelle;
...
public class CartAGenApplicationAgent extends GeOxygeneApplication
  ...
  private void reorganizeMenus() {
    // create the instance of the CartAGenPlugin
    ...
    //JMenu myplugin = new JMenu("My plugin");
    //PluginAzelle pa=new PluginAzelle("my plugin");
    //myplugin.add(new JMenuItem(pa.new ActionR2I()));
    PluginAzelle mine=new PluginAzelle("Mon menu");
    this.getMainFrame().getMenuBar().add(mine);
  }
